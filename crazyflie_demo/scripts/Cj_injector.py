...
class DroneInjector:
    ...
    def simple_rectangel_example(self, time_delay=None):
        ...
        #                       [----t----, ----x---, ---y---, --z--, yaw]
        path_maze_right_side = [
                                [step_time, 0 * step, 6 * step, 0.35, 0],  # start in (0,180,0.35)
        ...
        path_maze_left_side = [[step_time * 3, 0 * step, 4.5 * step, 0.35, 0],  # start in (0,300,0.35)
                               ...
                               # [step_time * 3, 5 * step, 4.5 * step, 0.35, 0],
                               [step_time * 3, 5 * step, 6.5 * step, 0.35, 0],

                               [step_time * 3, 7.5 * step, 6.5 * step, 0.35, 0],
                               # [step_time * 3, 7 * step, 6 * step, 0.35, 0],
                               [step_time * 3, 7.5 * step, 4 * step, 0.35, 0],
                               # [step_time * 2, 6.5 * step, 4 * step, 0.35, 0],
                               [step_time * 3, 6.5 * step, 4 * step, 0.35, 0],
                               [step_time * 3, 4.5 * step, 4 * step, 0.35, 0],
                               [step_time * 6, 0 * step, 4.5 * step, 0.35, 0],
                               [step_time * 2, 0 * step, 4.5 * step, 0, 0],
                               ]
        ...
        t1 = Thread(target=injector, args=(self.cj_injector_container[0], path_maze_left_side,))
        threads.append(t1)
